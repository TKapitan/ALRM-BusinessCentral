/// <summary>
/// Codeunit ART ALRM Management (ID 74179003).
/// </summary>
codeunit 74179003 "ART ALRM Management"
{
    SingleInstance = true;
    ...
    /// </summary>
    /// <param name="ForObjectType">Enum "ART Object Type", Specifies object type we want to check for IDs.</param>
    ...
    procedure UseObjectTypeIDs(ForObjectType: Enum "ART Object Type"; ShowError: Boolean): Boolean
    var
